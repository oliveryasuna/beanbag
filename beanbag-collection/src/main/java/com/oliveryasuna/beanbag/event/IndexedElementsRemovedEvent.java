...
public class IndexedElementsRemovedEvent<T, COL extends Collection<T>, SRC extends AbstractObservableCollection<T, COL, SRC>>
    extends CollectionEvent<T, COL, SRC> {

  // Constructors
  //--------------------------------------------------

  public IndexedElementsRemovedEvent(final SRC source, final Map<Integer, T> indexElementMap) {
    super(source);
  ...
  public boolean equals(final Object other) {
    ...
    final IndexedElementsRemovedEvent<?, ?, ?> otherCasted = (IndexedElementsRemovedEvent<?, ?, ?>)other;
